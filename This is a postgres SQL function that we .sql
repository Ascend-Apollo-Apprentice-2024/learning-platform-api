This is a postgres SQL function that we wrote: 
```sql
...
Please create a custom serializer in Django that converts results  from a SQL function above that takes one integer parameter called cohorts and coverts it to a json collection of objects that look like:
